...
<body>
	...
	<div class="card-body">
		...
		<p class="card-text">SMS (Student Management System) streamlines the process of adding
			new Student by dynamically generating a unique ID for each one and
			updating their details whenever necessary. It also facilitates
			deleting Student and displaying all Student records. <a
				href="add">Click here to Add a Student</a></p>
		</div>
	</div>
</body>
</html>